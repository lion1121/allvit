	...
	SEMICOLON.header = {
		...
		topsearch: function(){
			...
			$(document).on('click', function(event) {
				...
				if (!$(event.target).closest('#top-auth').length) { $topAuth.toggleClass('top-auth-open', false); }
			...
			$("#top-search-trigger").click(function(e){
				...
				$topAuth.toggleClass('top-auth-open', false);
				$( '#primary-menu > ul, #primary-menu > div > ul' ).toggleClass('d-block', false);
				$pagemenu.toggleClass('pagemenu-active', false);
        ...
        topauth: function(){
            ...
            $("#top-auth-trigger").click(function(e){
                $pagemenu.toggleClass('pagemenu-active', false);
                $topAuth.toggleClass('top-auth-open');
                e.stopPropagation();
                e.preventDefault();
            });
