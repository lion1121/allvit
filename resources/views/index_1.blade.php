...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/libs/libs.css')}}">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                <nav id="primary-menu">
                    ...
                    ============================================= -->
                    <div id="top-auth">
                        <a href="#" id="top-auth-trigger"><i class="icon-user"></i></a>
                        <div class="top-auth-wrapper">
                            <div class="top-auth-body">
                                <form id="login-form" name="login-form" class="nobottommargin" action="#" method="post">
                                    <div class="top-auth-title">
                                    ...
                                    <div class="col_full nobottommargin">
                                        <button class="button button-3d button-black nomargin" id="login-form-submit"
                                                name="login-form-submit" value="login">Войти
                                        </button>
                                ...
                                <div class="center">
                                    ...
                                    <h4 style="margin-bottom: 15px;">или войти через:</h4>
