...
{{--	<link rel="stylesheet" href="{{asset('css/libs/bootstrap/bootstrap.css')}}">--}}
	...
	<link rel="stylesheet" href="{{asset('css/libs/font-icons/font-icons.css')}}">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('css/libs/rs-plugin/css/settings.css')}}" media="screen" />
	<link rel="stylesheet" type="text/css" href="{{asset('css/libs/rs-plugin/css/layers.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('css/libs/rs-plugin/css/navigation.css')}}">
...
<body class="stretched">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="tabs topmargin-lg clearfix" id="tab-3">
						...
						<ul class="tab-nav clearfix" style="margin: inherit;">
	...
	<!-- Footer Scripts
	============================================= -->
	<script src="{{asset('js/libs/functions.js')}}"></script>

	<!-- SLIDER REVOLUTION 5.x SCRIPTS  -->
	<script src="{{asset('css/libs/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>

	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.video.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.actions.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.navigation.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.migration.min.js')}}"></script>
	<script src="{{asset('css/libs/rs-plugin/js/extensions/revolution.extension.parallax.min.js')}}"></script>
